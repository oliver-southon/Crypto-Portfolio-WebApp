...
def index():
    ...
    return render_template('index2.html', form=form, holdings=display_data, cum_pl=round(cum_pl,2), cum_pl_perc=round(cum_pl_perc,2), BTC=BTC, ETH=ETH)
